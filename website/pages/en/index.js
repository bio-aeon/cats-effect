            ...
            <SplashContainer>
                ...
                <div className="inner">
                    ...
                    <code className="hljs css language-sbt">
                        <span className="hljs-string">"org.typelevel"</span> %% <span className="hljs-string">"cats-effect"</span> % <span className="hljs-string">"3.5.7"</span>
                    </code>
                    <PromoSection>
                        <Button target="_blank" href="https://scastie.scala-lang.org/muBknkFtQq2lvUombKmlqA">Try It!</Button>
